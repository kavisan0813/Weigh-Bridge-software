...
export default function CustomerFormScreen({
  ...
  const [companyName, setCompanyName] = useState(
    prefill ? "Metro Builders Ltd" : "",
  );
  const [custType, setCustType] = useState(prefill ? "Company" : "Company");
  const [category, setCategory] = useState(
    prefill ? "Construction" : "Construction",
  );
  const [description, setDescription] = useState(
    prefill ? "Leading commercial infrastructure builder in Tamil Nadu." : "",
  );
  ...
  const [paymentTerms, setPaymentTerms] = useState(
    prefill ? "30 Days" : "30 Days",
  );

  // Address
  const [address1, setAddress1] = useState(
    prefill ? "No. 45 Industrial Estate" : "",
  );
  ...
  const [wbAccess, setWbAccess] = useState<Record<string, boolean>>({
    "WB-01": true,
    "WB-02": true,
    "WB-03": prefill,
    "WB-04": false,
  ...
  const [notes, setNotes] = useState(
    prefill ? "Priority customer. Credit limit pre-approved." : "",
  );
  ...
  const [activeSection, setActiveSection] = useState<
    "info" | "contact" | "business" | "address" | "ops" | "documents"
  >("info");
      ...
      >
        ...
        >
          <span style={{ color: "#F9FAFB", fontWeight: 700, fontSize: 13 }}>
            SCREEN 34 — {mode === "add" ? "ADD" : "EDIT"} CUSTOMER
          </span>
          <button
        ...
        >
          <div style={{ textAlign: "center", maxWidth: 400 }}>
            ...
            >
              You do not have permission to manage customer accounts.
            </p>
            <button
              ...
              >
                ...
                <button
                  onClick={() => {
                    ...
                    onNavigate(
                      mode === "edit" ? "customer-detail" : "customers",
                    );
                  }}
                  style={{
                    height: 40,
        ...
        >
          ...
          {mode === "edit" && (
            ...
            >
              ...
              <span style={{ color: secondaryText }}>
                Updated By:{" "}
                <strong style={{ color: primaryText }}>Admin User</strong>
              </span>
              <span style={{ color: mutedText }}>•</span>
              <span style={{ color: secondaryText }}>
                Customer ID:{" "}
                <strong style={{ color: primaryOrange }}>CUS-00124</strong>
              </span>
            </div>
          )}
            ...
            >
              ...
              >
                ...
                <SectionCard
                  ...
                  subtitle="Basic customer and company details."
                >
                  <div
                    style={{
                      display: "flex",
                    ...
                    <G2>
                      <F>
                        ...
                        <input
                          ...
                          placeholder="Metro Builders Ltd"
                      ...
                      <F>
                        ...
                        <input
                          value={
                            mode === "add"
                              ? "CUS-00124 (Auto-generated)"
                              : "CUS-00124"
                          }
                          disabled
                          style={{
                            ...inputStyle(),
                            background: dm ? "#111827" : "#F1F5F9",
                            color: mutedText,
                            fontWeight: 700,
                ...
                <SectionCard
                  ...
                  subtitle="Primary contact and communication details."
                >
                  <div
                    style={{
                      display: "flex",
                ...
                <SectionCard
                  ...
                  subtitle="Tax identification and payment configuration."
                >
                  <div
                    style={{
                      display: "flex",
                ...
                <SectionCard
                  ...
                  subtitle="Primary business location address."
                >
                  <div
                    style={{
                      display: "flex",
                    ...
                    <G2>
                      <F>
                        ...
                        <input
                          ...
                          placeholder="No. 45 Industrial Estate"
                ...
                <SectionCard
                  ...
                  subtitle="Configure permitted weighbridges and material defaults."
                >
                  <div
                    style={{
                      display: "flex",
                        ...
                        {Object.keys(wbAccess).map((wb) => (
                          <label
                            ...
                            style={{
                              ...
                              padding: 12,
                              borderRadius: 10,
                              border: `1.5px solid ${wbAccess[wb] ? primaryOrange : border}`,
                              background: wbAccess[wb]
                                ? primaryOrangeSoft
                                : elevated,
                              cursor: "pointer",
                            }}
                          >
                            ...
                            <div
                              style={{
                                fontSize: 10,
                                fontWeight: 700,
                                color: wbAccess[wb] ? primaryOrange : mutedText,
                              }}
                            >
                              {wbAccess[wb] ? "✓ ALLOWED" : "BLOCKED"}
                            </div>
                          </label>
                        ))}
                      </div>
                    ...
                    <G2>
                      <F>
                        ...
                        <select
                          value={defaultWb}
                          onChange={(e) => {
                            setDefaultWb(e.target.value);
                            dirty();
                          }}
                          style={selectStyle}
                        >
                          {["WB-01", "WB-02", "WB-03", "WB-04", "WB-05"].map(
                            (w) => (
                      ...
                      <F>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            setDefaultMaterial(e.target.value);
                            dirty();
                          }}
                          style={selectStyle}
                        >
                          {["Gravel", "Sand", "M-Sand", "Cement", "Steel"].map(
                            (m) => (
                ...
                <SectionCard
                  ...
                  subtitle="Upload business registration and contracts."
                >
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <button
                      style={{
                        ...
                        borderRadius: 8,
                        background: primaryOrangeSoft,
                        border: `1px dashed ${primaryOrange}`,
                        color: primaryOrange,
                        fontSize: 13,
                        fontWeight: 700,
                        cursor: "pointer",
                ...
                <SectionCard
                  ...
                  subtitle="Private notes for authorized staff members."
                >
                  <textarea
                    value={notes}
                    rows={3}
                  ...
                  />
                  <div
                    style={{ fontSize: 11.5, color: mutedText, marginTop: 6 }}
                  >
                    ℹ Internal notes are visible only to platform staff and
                    admins.
                  </div>
                </SectionCard>
              </div>
                ...
                >
                  ...
                  >
                    {[
                      ...
                      {
                        label: "Weighbridge assigned",
                        done: Object.values(wbAccess).some(Boolean),
                      },
