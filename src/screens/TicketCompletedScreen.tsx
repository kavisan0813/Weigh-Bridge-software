            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  background:
                    printState === st.id ? primaryOrange : "transparent",
          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  style={{ fontSize: 16, fontWeight: 800, color: statusOnline }}
                >
                  WEIGHMENT COMPLETED
                </div>
                <div
                ...
                >
                  Transaction recorded at 11:14 AM
                </div>
                <div
                  style={{
                    marginTop: 8,
              ...
              >
                ...
                <button
                  onClick={() =>
                    triggerToast("Downloading PDF ticket WB-2026-00463.pdf...")
                  }
                  style={{
                    height: 46,
                    borderRadius: 10,
              ...
              >
                <div
                  style={{ fontSize: 12, fontWeight: 800, color: statusOnline }}
                >
                  ● WB-01 READY FOR NEXT VEHICLE
                </div>
                <div style={{ fontSize: 11, color: mutedText, marginTop: 2 }}>
                  Current Platform Weight: 0 KG
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div>
                  ...
                  >
                    The vehicle weighment for ticket WB-2026-00463 has been
            ...
            <div
              style={{
                ...
                display: "grid",
                gridTemplateColumns:
                  viewDevice === "tablet" ? "1fr" : "1.1fr 0.9fr",
                gap: 24,
                overflowY: "auto",
              }}
            >
                ...
                >
                  ...
                  >
                    {[
                      ...
                      {
                        time: "10:55:24 AM",
                        title: "First Weighing Captured (Gross)",
                        detail: "24,850 KG recorded & verified",
                        done: true,
                      },
                      {
                        time: "11:12:42 AM",
                        title: "Second Weighing Captured (Tare)",
                        detail: "13,500 KG recorded & verified",
                        done: true,
                      },
                      {
                        time: "11:14:05 AM",
                        ...
                        detail:
                          "Net weight 11,350 KG calculated. Ticket WB-2026-00463 generated.",
                        done: true,
                      },
                    ].map((tl) => (
                      <div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{ fontSize: 11, color: mutedText, marginTop: 4 }}
                    >
                  ...
                  >
                    ...
                    >
                      <span style={{ color: mutedText }}>Date & Time:</span>{" "}
                      <strong>19 Aug 2026, 11:14 AM</strong>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <span style={{ color: mutedText }}>Vehicle Number:</span>{" "}
                      <strong
                        style={{
                          fontFamily: "monospace",
                          color: primaryOrange,
                    ...
                    >
                      <span style={{ color: mutedText }}>Customer:</span>{" "}
                      <strong>Metro Builders Ltd</strong>
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    <div
                      style={{ height: 1, background: border, margin: "6px 0" }}
                    />
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <span style={{ color: mutedText }}>Gross Weight:</span>{" "}
                    ...
                    >
                      <span style={{ color: mutedText }}>Tare Weight:</span>{" "}
                      <strong style={{ fontFamily: "monospace" }}>
                        13,500 KG
                      </strong>
                    </div>
                    ...
                    >
                      <span style={{ fontWeight: 800, color: primaryText }}>
                        NET WEIGHT:
                      </span>{" "}
                      <strong
                        style={{
                  ...
                  >
                    ...
                    >
                      <button
                        onClick={() =>
                          triggerToast(
                            "Downloading PDF ticket WB-2026-00463.pdf...",
                          )
                        }
                        style={{
                          height: 42,
                      ...
                      <button
                        onClick={() =>
                          triggerToast(
                            "Email sent to customer Metro Builders Ltd.",
                          )
                        }
                        style={{
                          height: 42,
                  ...
                  {printState === "printer-offline" && (
                    <div
                      style={{
                        ...
                        border: `1px solid ${statusWarning}`,
                        color: statusWarning,
                        fontSize: 11,
                        fontWeight: 700,
                        textAlign: "center",
                    ...
                    >
                      ⚠️ Printer offline — Weighment recorded cleanly. Use PDF
                      download.
                    </div>
                  )}
                </div>
