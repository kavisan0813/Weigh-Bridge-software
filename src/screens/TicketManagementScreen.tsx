...
const INITIAL_TICKETS: TicketRow[] = [
  {
    id: "1",
    code: "TKT-10248",
    title: "WB-02 Indicator Not Reading",
    category: "Indicator",
    weighbridge: "WB-02",
    priority: "HIGH",
    status: "OPEN",
  ...
  },
  {
    id: "2",
    code: "TKT-10247",
    title: "Printer Not Printing Ticket",
    category: "Printer",
    weighbridge: "WB-01",
    priority: "MEDIUM",
    status: "IN_PROGRESS",
  ...
  },
  {
    ...
    sla: "OVERDUE",
    isOverdue: true,
    lastUpdated: "20 Aug 2026 · 08:00 AM",
    creator: "Karthik P.",
  },
  {
    id: "4",
    code: "TKT-10245",
    title: "Network Intermittent Dropouts",
    category: "Network",
    weighbridge: "WB-03",
    priority: "HIGH",
    status: "RESOLVED",
  ...
  },
  {
    id: "5",
    code: "TKT-10244",
    title: "ANPR Plate Recognition Failure",
    category: "Camera",
    weighbridge: "WB-05",
    priority: "MEDIUM",
    status: "IN_PROGRESS",
  ...
  },
  {
    id: "6",
    code: "TKT-10243",
    title: "Load Cell Zero Calibration Drift",
  ...
  },
  {
    id: "7",
    code: "TKT-10242",
    title: "Barrier Gate Sensor Unresponsive",
    category: "Hardware",
    weighbridge: "WB-02",
    priority: "LOW",
    status: "CLOSED",
    assignedTo: "Field Tech",
    created: "17 Aug 2026",
    sla: "Completed",
    isOverdue: false,
...
export default function TicketManagementScreen({
  ...
  const filteredList = useMemo(() => {
    return INITIAL_MATERIALS_TICKETS(role)
      .filter((item) => {
        const matchSearch =
        ...
        const matchStatus =
          activeSt === "ALL" ||
          item.status === activeSt ||
          (activeSt === "OVERDUE" && item.isOverdue);
        const matchPriority =
        ...
        const matchAssigned =
          assignedFilter === "ALL" || item.assignedTo === assignedFilter;
        ...
        {createTicketModalOpen && (
          ...
          >
            ...
            >
              ...
              >
                Report an operational issue with a weighbridge, indicator,
                camera, printer or software component.
              </p>
              <div
              ...
              >
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. WB-03 Loadcell Zero Offset Error"
                    style={{
                      width: "100%",
                      height: 42,
                      padding: "0 12px",
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 12, color: mutedText, margin: "2px 0 0 0" }}>
              Track, assign and manage operational support and maintenance
              issues.
            </p>
          </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div>
                ...
                >
                  14 Tickets Past SLA (Overdue)
                </div>
                <div
                  style={{ fontSize: 12, color: dm ? "#FCA5A5" : "#991B1B" }}
                >
                  Critical weighbridge and hardware tickets require immediate
                  technician dispatch.
                </div>
              </div>
            </div>
            ...
            {[
              {
                label: "TOTAL TICKETS",
                val: "248",
                support: "All accessible tickets",
                color: primaryText,
                icon: "🎟",
              },
              {
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: 12, color: kpi.color }}>
                    {kpi.icon}
                  </span>
                </div>
                <div
          ...
          >
            ...
            >
              ...
              <select
                ...
                style={selectStyle(dm, border, inputBg, primaryText)}
              >
            ...
            {activeFilterCount > 0 && (
              ...
              >
                ...
                {priorityFilter !== "ALL" && (
                  <span style={chipStyle(primaryOrangeSoft, primaryOrange)}>
                    Priority: {priorityFilter}
                  </span>
                )}
                {categoryFilter !== "ALL" && (
                  <span style={chipStyle(secondaryGoldSoft, secondaryGold)}>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  {filteredList.length} tickets accessible
                </p>
              </div>
              ...
              {role === "admin" && (
                <div style={{ display: "flex", gap: 8 }}>
                  <button
                    onClick={() => alert("Bulk Assign Tickets")}
                    style={{
                      padding: "6px 12px",
                      borderRadius: 6,
                      background: elevated,
                  ...
                  <button
                    onClick={() => alert("Exporting Tickets...")}
                    style={{
                      padding: "6px 12px",
                      borderRadius: 6,
                      background: elevated,
                                ...
                                >
                                  ...
                                  {role === "admin" && (
                                    <>
                                      ...
                                      <button
                                        onClick={() =>
                                          alert(`Change Priority ${row.code}`)
                                        }
                                        style={menuBtnStyle(false)}
                                      >
                                        Change Priority
            ...
            >
              <div style={{ fontSize: 12.5, color: mutedText }}>
                Showing <strong>1–{filteredList.length}</strong> of{" "}
                <strong>248</strong> tickets
              </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 10, color: mutedText, fontWeight: 700 }}
                  >
                    OPEN
                  </div>
                  <div
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <strong
                        style={{
                          color: item.isOverdue ? statusError : primaryText,
                        }}
                      >
                        {item.sla}
                      </strong>
