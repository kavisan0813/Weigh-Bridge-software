...
export default function DriverFormScreen({
  ...
  const [notes, setNotes] = useState(
    prefill ? "Experienced driver for WB-01 and WB-02 routes." : "",
  );

  // License Information
  const [licenseNo, setLicenseNo] = useState(prefill ? "TN-XX-XXXXXXXX" : "");
  const [licenseType, setLicenseType] = useState(
    prefill ? "Heavy Vehicle" : "Heavy Vehicle",
  );
  ...
  const [activeSection, setActiveSection] = useState<
    "personal" | "license" | "assignment" | "documents"
  >("personal");
  ...
  const Label = ({ text, required }: { text: string; required?: boolean }) => (
    ...
    >
      {text}
      {required && <span style={{ color: statusError, marginLeft: 2 }}>*</span>}
    </div>
  );

  const FieldErr = ({ errKey }: { errKey: string }) =>
    errors[errKey] ? (
      <div style={{ fontSize: 11.5, color: statusError, marginTop: 4 }}>
        ⚠ {errors[errKey]}
      </div>
    ) : null;
  ...
  const SectionCard = ({
    ...
    >
      <div
        style={{ padding: "14px 24px", borderBottom: `1px solid ${border}` }}
      >
        <h3
          style={{
            margin: 0,
      ...
      >
        ...
        >
          <span style={{ color: "#F9FAFB", fontWeight: 700, fontSize: 13 }}>
            SCREEN 30 — {mode === "add" ? "ADD" : "EDIT"} DRIVER
          </span>
          <button
        ...
        >
          <div style={{ textAlign: "center", maxWidth: 400 }}>
            ...
            <h2 style={{ margin: "0 0 8px 0", fontSize: 20, fontWeight: 900 }}>
              ACCESS RESTRICTED
            </h2>
            <p
              style={{ color: secondaryText, fontSize: 13.5, marginBottom: 20 }}
            >
              You do not have permission to manage driver information.
            </p>
            <button
      ...
      >
              ...
              {(["add", "edit"] as FormMode[]).map((m) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 4,
                    border: "none",
                    background: mode === m ? secondaryGold : "transparent",
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: "0 24px",
                  borderRadius: 8,
                  background: isSaving ? mutedText : primaryOrange,
                  color: "#FFF",
                  border: "none",
                  fontSize: 13,
                  fontWeight: 800,
          ...
          {mode === "edit" && (
            ...
            >
              <span style={{ color: secondaryGold, fontWeight: 700 }}>
                ℹ Last Updated:
              </span>
              ...
              <span style={{ color: secondaryText }}>
                By <strong style={{ color: primaryText }}>Admin</strong>
              </span>
              <span style={{ color: mutedText }}>•</span>
              <span style={{ color: secondaryText }}>
                Driver ID:{" "}
                <strong style={{ color: primaryOrange }}>DRV-00124</strong>
              </span>
            </div>
          )}
              ...
              {SECTIONS.map((sec) => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      activeSection === sec.key ? primaryOrange : mutedText,
                    background: "none",
                    border: "none",
                    borderBottom:
              ...
              >
                ...
                {activeSection === "personal" && (
                  <>
                    <SectionCard
                      ...
                      subtitle="Driver's name, contact and address details."
                    >
                      <div
                        style={{
                          display: "flex",
                ...
                {activeSection === "license" && (
                  <SectionCard
                    ...
                    subtitle="Driving license details and verification status."
                  >
                    <div
                      style={{
                        display: "flex",
                      ...
                      <G2>
                        <F>
                          ...
                          <input
                            ...
                            placeholder="TN-XX-XXXXXXXX"
                            style={inputStyle("licenseNo")}
                            onFocus={(e) =>
                              (e.target.style.borderColor = primaryOrange)
                            }
                            onBlur={(e) =>
                      ...
                      <G3>
                        <F>
                          ...
                          <input
                            ...
                            type="date"
                            onChange={(e) => {
                              setLicenseIssue(e.target.value);
                              dirty();
                            }}
                            style={{ ...inputStyle(), cursor: "pointer" }}
                            onFocus={(e) =>
                          ...
                          return (
                            <div
                              style={{
                                padding: 14,
                                borderRadius: 10,
                                background: dm ? `${color}18` : `${color}12`,
                ...
                {activeSection === "assignment" && (
                  <>
                    <SectionCard
                      ...
                      subtitle="Assign one or more vehicles to this driver."
                    >
                      <div
                        style={{
                          display: "flex",
                        ...
                        {vehicle1 && (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <div
                                style={{ color: secondaryText, marginTop: 2 }}
                              >
                                Heavy Truck • Tata Prima 2830.K • WB-01
                              </div>
                            </div>
                          </div>
                        )}
                    ...
                    <SectionCard
                      ...
                      subtitle="Associate this driver with a customer or company."
                    >
                      <F>
                      ...
                      {customer && (
                        ...
                        >
                          <div style={{ fontWeight: 800, color: primaryText }}>
                            {customer}
                          </div>
                          <div style={{ color: mutedText, marginTop: 2 }}>
                            Business • Active Customer
                          </div>
                        </div>
                      )}
                    </SectionCard>
                ...
                {activeSection === "documents" && (
                  <SectionCard
                    ...
                    subtitle="Upload and manage driver compliance documents."
                  >
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      {(
                        ...
                        <div
                          ...
                          style={{
                            ...
                            borderRadius: 10,
                            background: elevated,
                            border: `1px solid ${doc.value ? primaryOrange : border}`,
                          }}
                        >
                          <div
                            style={{
                          ...
                          >
                            ...
                            <div style={{ display: "flex", gap: 8 }}>
                              ...
                              <button
                                onClick={() => {
                                  (doc.setter as (v: string) => void)(
                                    doc.value ? "" : `${doc.key}_document.pdf`,
                                  );
                                  dirty();
                                }}
                                style={{
                                  ...
                                  padding: "0 14px",
                                  borderRadius: 8,
                                  border: `1px solid ${doc.value ? statusError : primaryOrange}`,
                      ...
                      <div
                        style={{
                          padding: 12,
                          background: dm ? "rgba(201,154,46,0.1)" : "#FFFBEB",
                          borderRadius: 10,
                          border: `1px solid ${secondaryGold}`,
                          fontSize: 12.5,
                          color: secondaryText,
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            padding: "10px 12px",
                            borderRadius: 10,
                            border: `1.5px solid ${status === s ? sc : border}`,
                            background:
                              status === s
                                ? dm
                                  ? `${sc}18`
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: 16,
                              borderRadius: 999,
                              border: `2px solid ${status === s ? sc : border}`,
                              background: status === s ? sc : "transparent",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              flexShrink: 0,
                    ...
                    {[
                      {
                        ...
                        done: !!(firstName && lastName && phone),
                      },
                      {
                        label: "License details",
                        done: !!(licenseNo && licenseExpiry),
                      },
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: 18,
                            borderRadius: 4,
                            border: `2px solid ${done ? statusSuccess : border}`,
                            background: done ? statusSuccess : "transparent",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            flexShrink: 0,
                        ...
                        <span style={{ color: done ? primaryText : mutedText }}>
                          {label}
                        </span>
                      </div>
                    ))}
  ...
  function renderMobile() {
    ...
    const stepIndex = STEPS.findIndex((s) =>
      s.toLowerCase().startsWith(activeSection),
    );
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{ display: "flex", borderBottom: `1px solid ${border}` }}
            >
              {STEPS.map((step, idx) => (
                <button
                  key={step}
                  onClick={() =>
                    setActiveSection(step.toLowerCase() as typeof activeSection)
                  }
                  style={{
                    flex: 1,
                    padding: "10px 0",
                    fontSize: 10.5,
                    fontWeight: idx === stepIndex ? 800 : 500,
                    color: idx === stepIndex ? primaryOrange : mutedText,
                    background: "none",
                    border: "none",
                    borderBottom:
                      idx === stepIndex
                ...
                <>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{ ...selectStyle, height: 48, fontSize: 14 }}
                    >
                      {["Heavy Vehicle", "Medium Vehicle", "Light Vehicle"].map(
                        (t) => (
                          <option key={t}>{t}</option>
                        ),
                      )}
                  ...
                  {[
                    ["Issue Date", licenseIssue, setLicenseIssue],
                    ["Expiry Date *", licenseExpiry, setLicenseExpiry],
                ...
                <>
                  {[
                    [
                      ...
                      vehicle1,
                      setVehicle1,
                      ["No vehicle", "TN22GH3456", "TN38AB7821", "TN11EF9021"],
                    ],
                    [
                      "Customer",
                      customer,
                    ...
                    <div key={label as string}>
                      ...
                      >
                        {(opts as string[]).map((o) => (
                          <option key={o} value={o.startsWith("No") ? "" : o}>
                            {o}
                          </option>
                        ))}
                      </select>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: 10,
                            border: `1.5px solid ${status === s ? sc : border}`,
                            background: status === s ? `${sc}12` : elevated,
                            cursor: "pointer",
                            width: "100%",
                            marginBottom: 8,
                          }}
                      ...
                      >
                        <div>
                          ...
                          <div
                            style={{
                              fontSize: 11.5,
                              color: doc.value ? statusSuccess : mutedText,
                              marginTop: 2,
                            }}
                          >
                        ...
                        <button
                          onClick={() => {
                            doc.setter(
                              doc.value
                                ? ""
                                : `${doc.label.toLowerCase().replace(/\s/g, "_")}.pdf`,
                            );
                            dirty();
                          }}
                          style={{
                            ...
                            background: doc.value
                              ? "rgba(220,38,38,0.1)"
                              : primaryOrangeSoft,
                            color: doc.value ? statusError : primaryOrange,
                            fontSize: 12,
                            fontWeight: 700,
                            cursor: "pointer",
                          }}
