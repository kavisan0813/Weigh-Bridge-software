...
export default function TransactionDetailScreen({ darkMode: dm, onToggleDark, onLogout, onNavigate }: Props) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: p.bg, color: p.text, fontFamily: "'Inter', -apple-system, sans-serif" }}>
      {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
          TOP TESTING BAR (Viewport, Role & Transaction State Selector)
         ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
      <header
        style={{
          width: "100%",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ height: 16, width: 1, background: p.border }} />
          <span style={{ fontWeight: 800, letterSpacing: "0.08em", color: p.primaryOrange }}>SCREEN 26 — TRANSACTION DETAIL</span>
        </div>

        <div style={{ display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          {/* Device Switcher */}
          <div style={{ display: "flex", alignItems: "center", gap: 4, background: p.sub, padding: 3, borderRadius: 8, border: `1px solid ${p.border}` }}>
            {(["desktop", "tablet", "mobile"] as ViewDevice[]).map((dev) => (
              <button
                key={dev}
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: viewDevice === dev ? p.primaryOrange : "transparent",
                  color: viewDevice === dev ? "#FFF" : p.secondary,
                  fontWeight: viewDevice === dev ? 700 : 500,
                  fontSize: 11,
                  cursor: "pointer",
                  textTransform: "capitalize",
                }}
              >
                {dev === "desktop" ? "🖥 Desktop 1440" : dev === "tablet" ? "📱 Tablet 768" : "📲 Mobile 390"}
              </button>
            ))}
          </div>
            ...
            {(["admin", "operator"] as UserRole[]).map((r) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: role === r ? p.secondaryGold : "transparent",
                  color: role === r ? "#FFF" : p.secondary,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 11, color: p.muted, fontWeight: 600 }}>Tx State:</span>
            <select
              value={txState}
              onChange={(e) => setTxState(e.target.value as TransactionStatusState)}
              style={{
                padding: "4px 8px",
                borderRadius: 6,
            ...
            >
              ...
              <option value="AWAITING_SECOND">AWAITING SECOND</option>
          ...
          {/* Theme & Logout */}
          <button onClick={onToggleDark} style={{ background: p.sub, border: `1px solid ${p.border}`, color: p.text, padding: "5px 10px", borderRadius: 6, cursor: "pointer", fontSize: 12 }}>
            {dm ? "☀️ Light" : "🌙 Dark"}
          </button>
          <button onClick={onLogout} style={{ background: "none", border: `1px solid ${p.border}`, color: p.secondary, padding: "5px 10px", borderRadius: 6, cursor: "pointer", fontSize: 12 }}>
            Logout
          </button>
        </div>
      </header>
