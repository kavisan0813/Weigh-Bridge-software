...
export default function TransactionDetailScreen({
  ...
  const [notesText, setNotesText] = useState(
    "Vehicle arrived with additional material. Operator verified vehicle before second weighing.",
  );
    ...
    switch (state) {
      case "COMPLETED":
        return {
          ...
          bg: dm ? "rgba(22, 163, 74, 0.15)" : "#F0FDF4",
          border: "#BBF7D0",
        };
      case "AWAITING_SECOND":
        return {
          label: "● AWAITING SECOND WEIGHING",
      ...
      case "IN_PROGRESS":
        return {
          label: "⏳ IN PROGRESS",
          color: p.statusProcessing,
          bg: dm ? "rgba(139, 92, 246, 0.15)" : "#F3E8FF",
          border: "#DDD6FE",
        };
      case "CANCELLED":
        return {
          label: "✕ CANCELLED",
          color: p.statusError,
          bg: dm ? "rgba(220, 38, 38, 0.15)" : "#FEF2F2",
          border: "#FECACA",
        };
      case "DRAFT":
        return {
          label: "● DRAFT",
          color: p.muted,
          bg: dm ? "rgba(156, 163, 175, 0.15)" : "#F1F5F9",
          border: p.border,
        };
      case "ERROR":
        return {
  ...
  const auditEvents = [
    ...
    },
    {
      ...
      user: "System",
      value: "WB-01 Thermal Printer (1 Copy)",
    },
  ];
    ...
    >
      ...
      <div
        style={{
          ...
          padding: viewDevice === "desktop" ? "0" : "20px 0",
        }}
      >
        {viewDevice === "mobile" ? (
          /* -------------------------------------------------------------
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <div>
                    <div style={{ fontSize: 10.5, color: p.secondary }}>
                      Gross Weight
                    </div>
                    <div
                      style={{
              ...
              >
                ...
                >
                  <span
                    style={{ fontSize: 11, fontWeight: 800, color: p.muted }}
                  >
                    VEHICLE & DRIVER
                  </span>
                  <button
                    onClick={() => onNavigate("vehicle-detail")}
                    style={{
                      background: "none",
                      border: 0,
                      color: p.primaryOrange,
              ...
              >
                ...
                >
                  <div
                    style={{
                      borderLeft: `2px solid ${p.statusSuccess}`,
                      paddingLeft: 10,
                    }}
                  >
                    <div
                      style={{ fontSize: 12, fontWeight: 800, color: p.text }}
                    >
                      Step 1: Vehicle Entry (10:52 AM)
                    </div>
                    <div style={{ fontSize: 11, color: p.secondary }}>
                      Gate registration verified
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    <div
                      style={{ fontSize: 12, fontWeight: 800, color: p.text }}
                    >
                      Step 2: First Weighing (10:55 AM)
                    </div>
                    <div style={{ fontSize: 11, color: p.secondary }}>
                      Gross: 24,850 KG (Stable)
                    </div>
                  </div>
                  <div
                    style={{
                      borderLeft: `2px solid ${txState === "AWAITING_SECOND" ? p.statusWarning : p.statusSuccess}`,
                      paddingLeft: 10,
                    }}
                  >
                    <div
                      style={{ fontSize: 12, fontWeight: 800, color: p.text }}
                    >
                      Step 3: Second Weighing (11:12 AM)
                    </div>
                    <div style={{ fontSize: 11, color: p.secondary }}>
                      {txState === "AWAITING_SECOND"
                        ? "Pending vehicle return"
                        : "Tare: 13,500 KG (Stable)"}
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    return (
                      ...
                      >
                        <span
                          style={{
                            fontSize: 14,
                            color: active ? p.primaryOrange : p.secondaryGold,
                          }}
                        >
                          {icon}
                        </span>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <span>/</span>
                    <span style={{ color: p.primaryOrange, fontWeight: 700 }}>
                      Transaction Detail
                    </span>
                  </div>
                  <h1
                  ...
                  >
                    CompleteInformation and certified weighing history for this
                    transaction.
                  </p>
                </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div
                    style={{ fontSize: 12, textAlign: "right", marginRight: 8 }}
                  >
                    <div style={{ fontWeight: 800, color: p.primaryOrange }}>
                      WB-01 — Main Gate
                    </div>
                  ...
                  {role === "admin" && (
                    <button
                      ...
                      style={{
                        ...
                        padding: "0 12px",
                        borderRadius: 8,
                        background: dm ? "rgba(220,38,38,0.15)" : "#FEF2F2",
                        color: p.statusError,
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      <span>
                        Date:{" "}
                        <strong style={{ color: p.text }}>19 Aug 2026</strong>
                      </span>
                      <span>
                        Time:{" "}
                        <strong style={{ color: p.text }}>11:14 AM</strong>
                      </span>
                      <span>
                        Vehicle:{" "}
                        <strong style={{ color: p.primaryOrange }}>
                          TN22GH3456
                        </strong>
                      </span>
                      <span>
                ...
                <div
                  style={{
                    background: p.surface,
                    borderRadius: 16,
                    border: `2px solid ${p.primaryOrange}`,
                    padding: 24,
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{ fontSize: 12, color: p.muted, fontWeight: 600 }}
                    >
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        padding: 18,
                        borderRadius: 12,
                        border: `1px solid ${p.secondaryGold}`,
                      }}
                    >
                      <div
                        style={{
                    ...
                    >
                      ...
                      >
                        {txState === "AWAITING_SECOND"
                          ? "Gross 24,850 KG captured"
                          : "11.35 Metric Tons Net Material"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {txState === "WITH_WARNING" && (
                  ...
                  >
                    ...
                    >
                      ⚠️ TARE VARIANCE WARNING
                    </div>
                    <div style={{ fontSize: 12, color: p.text, marginTop: 4 }}>
                      Tare weight difference (+50 KG) exceeded baseline (13,450
                      KG registered vs 13,500 KG actual). Status: ✓ Within
                      Allowed ±100 KG Tolerance.
                    </div>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ fontWeight: 800, color: statusBadge.color }}
                        >
                          {statusBadge.label}
                        </span>
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ fontWeight: 800, color: p.statusSuccess }}
                        >
                          ● VALID (TN-XX-XXXXXXXX)
                        </span>
                      </div>
                    </div>
                  </section>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ fontWeight: 800, color: p.primaryOrange }}
                        >
                          Gravel • 11,350 KG
                        </span>
                      </div>
                    ...
                    >
                      ...
                      <div style={{ display: "flex", gap: 14 }}>
                        ...
                        <div>
                          ...
                          >
                            {txState === "AWAITING_SECOND"
                              ? "Awaiting vehicle return to scale"
                              : "Tare Weight Captured: 13,500 KG (Stable)"}
                          </div>
                        </div>
                      </div>
                      ...
                      <div style={{ display: "flex", gap: 14 }}>
                        ...
                        <div>
                          ...
                          >
                            Step 4: Weighment Completed (11:14 AM)
                          </div>
                          <div
                            style={{
                              fontSize: 12,
                          ...
                          >
                            {txState === "AWAITING_SECOND"
                              ? "Pending final net weight calculation"
                              : "Certified Net Weight: 11,350 KG • Ticket Generated"}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <strong style={{ color: p.statusSuccess }}>
                          ✓ Connected
                        </strong>
                      </div>
                      <div
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{
                        background: dm ? "#172033" : "#FFFBEB",
                        borderRadius: 12,
                        border: `1px dashed ${p.secondaryGold}`,
                        padding: 16,
                    ...
                    >
                      ...
                      >
                        Main Gate • WB-01 • Ticket: WB-2026-00463
                      </div>
                      <div
                        style={{
                  ...
                  >
                    ...
                    >
                      {auditEvents.map((evt, i) => (
                        ...
                        >
                          <div>
                            <div style={{ fontWeight: 800, color: p.text }}>
                              {evt.action}
                            </div>
                            <div style={{ fontSize: 11, color: p.secondary }}>
                              {evt.value} • By {evt.user}
                            </div>
                          </div>
                          <span
                            style={{
        ...
        >
          ...
          >
            ...
            >
              <div>
                <label
                  style={{ fontSize: 11, fontWeight: 700, color: p.muted }}
                >
            ...
            >
              ...
              <button
                onClick={() => {
                  ...
                  showToast(
                    "✓ Ticket printed successfully on WB-01 Thermal Printer",
                  );
                }}
                style={{
                  height: 40,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Export Transaction WB-2026-00463
              </h3>
              <button
      ...
      {showCancelModal && (
        ...
        >
          ...
          >
            ...
            >
              Cancel Transaction WB-2026-00463?
            </h3>
            <p
              style={{ margin: "0 0 14px 0", fontSize: 13, color: p.secondary }}
            >
              Cancelling will invalidate this ticket. Historical weighing audit
              logs will remain preserved for legal compliance.
            </p>
            <input
              placeholder="Reason for cancellation (e.g. Duplicate Entry)"
              style={{
                width: "100%",
                height: 40,
                borderRadius: 8,
      ...
      {showImageLightbox && (
        ...
        >
          ...
          >
            ...
            >
              <span style={{ fontSize: 16, fontWeight: 900, color: p.text }}>
                TN22GH3456 — Weighment Photo (WB-01)
              </span>
              <button
            ...
            >
              <span style={{ fontSize: 12, color: p.muted }}>
                Captured: 19 Aug 2026, 10:55 AM • ANPR Verified
              </span>
              <button
                onClick={() => setShowImageLightbox(false)}
                style={{
