...
export default function VehicleFormScreen({
  ...
  const [vehicleType, setVehicleType] = useState(
    prefill ? "Heavy Truck" : "Heavy Truck",
  );
  const [category, setCategory] = useState(
    prefill ? "Commercial" : "Commercial",
  );
  ...
  const inputStyle = (err?: string): React.CSSProperties => ({
    ...
    background: inputBg,
    color: primaryText,
    border: `1.5px solid ${err ? statusError : border}`,
    fontSize: 13,
    outline: "none",
  ...
  const SectionHeader = ({
    ...
    <div style={{ padding: "14px 24px", borderBottom: `1px solid ${border}` }}>
      <h3
        style={{ margin: 0, fontSize: 15, fontWeight: 800, color: primaryText }}
      >
        {title}
      </h3>
      {subtitle && (
      ...
      >
        ...
        >
          <div style={{ textAlign: "center", maxWidth: 400 }}>
            ...
            >
              You do not have permission to manage vehicle information.
            </p>
            <button
      ...
      >
        ...
        {showDiscard && (
          ...
          >
            ...
            >
              <h3
                style={{ margin: "0 0 8px 0", fontSize: 18, fontWeight: 900 }}
              >
                Discard Changes?
              </h3>
              <p
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: "#F9FAFB" }}>
              SCREEN 28 — {mode === "add" ? "ADD" : "EDIT"} VEHICLE
            </span>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                {mode === "add"
                  ? "Register a new vehicle for weighbridge operations."
                  : "Update vehicle information, tare weight and assignments."}
              </p>
            </div>
          ...
          {mode === "edit" && (
            ...
            >
              ...
              <span style={{ color: secondaryText }}>
                Updated by <strong style={{ color: primaryText }}>Admin</strong>
              </span>
              <span style={{ color: mutedText }}>•</span>
              <span style={{ color: secondaryText }}>
                Vehicle:{" "}
                <strong style={{ color: primaryOrange }}>TN22GH3456</strong>
              </span>
            </div>
          )}
              ...
              >
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Basic identification and registration details."
                  />
                  <div
                    style={{
                      padding: 24,
                    ...
                    <G2>
                      ...
                      <F>
                        ...
                        <select
                          ...
                          style={selectStyle}
                        >
                          {["Commercial", "Private", "Government"].map((o) => (
                            <option key={o}>{o}</option>
                          ))}
                        </select>
                      </F>
                    ...
                    <G2>
                      ...
                      <F>
                        ...
                        <select
                          ...
                          style={selectStyle}
                        >
                          {["Diesel", "Petrol", "CNG", "Electric"].map((o) => (
                            <option key={o}>{o}</option>
                          ))}
                        </select>
                      </F>
                ...
                >
                  <SectionHeader
                    title="Tare Weight & Capacity"
                    subtitle="Weight configuration for accurate net weight calculation."
                  />
                  <div
                    style={{
                      padding: 24,
                  ...
                  >
                    ...
                    >
                      ...
                      Registered tare is used as the default. Actual tare is
                      re-measured per weighment cycle.
                    </div>
                  </div>
                </div>
                ...
                >
                  <SectionHeader
                    title="Weighbridge Access"
                    subtitle="Select which weighbridges this vehicle is permitted to use."
                  />
                        ...
                        >
                          ...
                          <div
                            style={{
                              fontSize: 13,
                              fontWeight: 800,
                              color: wbAccess[wb] ? primaryOrange : primaryText,
                            }}
                          >
                            {wb}
                          </div>
                ...
                >
                  ...
                  <div style={{ padding: 24 }}>
                    <textarea
                      ...
                      placeholder="Enter additional information about this vehicle..."
                      style={{
                        width: "100%",
                        borderRadius: 8,
                        padding: "12px 14px",
                ...
                >
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    {customer && (
                      ...
                      >
                        <div style={{ fontWeight: 700, color: primaryText }}>
                          {customer}
                        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ← {mode === "edit" ? "Vehicle Detail" : "Vehicles"}
              </button>
              <span
            ...
            >
              ...
              {[
                [
                  ...
                  vehicleType,
                  setVehicleType,
                  ["Heavy Truck", "Medium Truck", "Light Vehicle", "Trailer"],
                ],
