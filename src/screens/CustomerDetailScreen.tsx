...
const TIMELINE = [
  {
    ...
    desc: "Ticket WB-2026-00462 · 24,850 KG Net Gravel",
  },
  {
    date: "18 Aug 2026",
  ...
  },
  {
    ...
    desc: "TN38CD5567 added to account",
  },
  {
    date: "10 Aug 2026",
    title: "Customer information updated",
    desc: "Tax ID & address updated by Admin",
  },
];
        ...
        {showDeactivateModal && (
          ...
          >
            ...
            >
              ...
              >
                Metro Builders Ltd will no longer be permitted to perform new
              ...
              >
                Historical transactions will remain accessible in reports.
              </p>
              <div
        ...
        >
          ...
          >
            <div>
              ...
              >
                Customer information, vehicles, drivers and weighment activity.
              </p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              {role === "admin" && (
                <>
                  ...
                  <button
                    onClick={() => onNavigate("customer-edit")}
                    style={{
                      height: 42,
                      padding: "0 18px",
                      borderRadius: 8,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          Basic company identification and business details.
                        </div>
                      </div>
                      <div style={{ padding: "0 20px 8px" }}>
                        <InfoRow
                          label="Company Name"
                          value="Metro Builders Ltd"
                          divider={divider}
                          mutedText={mutedText}
                        ...
                        <InfoRow
                          label="Email Address"
                          value="contact@metrobuilders.com"
                          divider={divider}
                          mutedText={mutedText}
                          primaryText={primaryText}
                        />
                        <InfoRow
                          ...
                          value="No. 45 Industrial Estate, Guindy, Chennai, Tamil Nadu"
                          divider={divider}
                          mutedText={mutedText}
                          primaryText={primaryText}
                        />
                    ...
                    >
                      ...
                      >
                        {[
                          {
                            wb: "WB-01 (Main Gate)",
                            count: "846 weighments",
                            active: true,
                          },
                          {
                            wb: "WB-02 (North Gate)",
                            count: "302 weighments",
                            active: true,
                          },
                          {
                            wb: "WB-03 (Loading Yard)",
                            count: "100 weighments",
                            active: true,
                          },
                          {
                            wb: "WB-04 (Dispatch Gate)",
                            count: "—",
                            active: false,
                          },
                          {
                            wb: "WB-05 (Raw Material)",
                            count: "—",
                            active: false,
                          },
                        ].map((st) => (
                          ...
                          >
                            <span
                              style={{ fontWeight: 700, color: primaryText }}
                            >
                              {st.wb}
                            </span>
                            <span
                    ...
                    >
                      ...
                      >
                        {[
                          {
                            name: "Gravel",
                            count: "486 weighments",
                            weight: "12,400 TON",
                          },
                          {
                            name: "Sand",
                            count: "328 weighments",
                            weight: "8,150 TON",
                          },
                          {
                            name: "M-Sand",
                            count: "241 weighments",
                            weight: "5,300 TON",
                          },
                          {
                            name: "Cement",
                            count: "193 weighments",
                            weight: "2,600 TON",
                          },
                        ].map((m) => (
                          <div
                          ...
                          >
                            ...
                            <span
                              style={{ fontWeight: 800, color: secondaryGold }}
                            >
                              {m.weight}
                            </span>
                          </div>
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      24 vehicles associated with Metro Builders Ltd.
                    </div>
                  </div>
                </div>
                <table
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11.5, color: mutedText, marginTop: 2 }}
                    >
                      18 drivers associated with Metro Builders Ltd.
                    </div>
                  </div>
                </div>
                <table
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11.5, color: mutedText, marginTop: 2 }}
                    >
                      1,248 total transactions for Metro Builders Ltd.
                    </div>
                  </div>
                </div>
                <table
        ...
        >
          ...
          >
            ...
            >
              ...
              {role === "admin" ? (
                <button
                  onClick={() => alert("Opening Add/Edit Customer Screen 34")}
                  style={{
                    background: "none",
                    border: 0,
                    color: primaryOrange,
            ...
            >
              ...
              >
                {[
                  ["VEHICLES", "24", primaryOrange],
                  ["DRIVERS", "18", secondaryGold],
                  ["WEIGHMENTS", "1,248", primaryText],
                  ["NET WEIGHT", "28,450 T", statusSuccess],
                ].map(([l, v, c]) => (
                  <div
                    key={l}
                    style={{
