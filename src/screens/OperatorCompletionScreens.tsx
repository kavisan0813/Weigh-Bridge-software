...
export default function OperatorCompletionScreens({
  view,
  darkMode,
  onToggleDark,
  onLogout,
...
function SecondWeighingScreen({
  ...
  const secondWeightValues = {
    "no-vehicle": {
      ...
      message:
        "Drive the vehicle onto the weighbridge platform for second weighing.",
      canCapture: false,
    },
    detecting: {
      value: 13420,
  ...
  const handleConfirmWeight = () => {
    ...
    setTimeout(() => {
      ...
      alert(
        "Audit Log Event Created: Second Weight Captured (13,500 KG) | Net Computed: 11,350 KG for WB-2026-00463.",
      );
    }, 1200);
  };
  ...
  const handleCompleteWeighment = () => {
    alert(
      "Audit Log Event: Weighment WB-2026-00463 Completed! Generating Ticket...",
    );
        ...
        {viewDevice === "mobile" ? (
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div>
                  ...
                  >
                    Capture the tare weight and complete ticket WB-2026-00463
                    for vehicle TN22GH3456.
                  </p>
                </div>
              </div>
            </header>
            ...
            {weightState === "tolerance-warning" && (
              ...
              >
                <div>
                  ⚠️ Tare Weight Difference Warning: Current tare (14,400 KG)
                  exceeds expected tare (13,500 KG) by +900 KG. (Limit: ±500
                  KG).
                </div>
                <button
              ...
              >
                ...
                >
                  ...
                  >
                    {[
                      {
                        label: "Locked first gross weight verified (24,850 KG)",
                        ok: true,
                      },
                      {
                        label: "Second tare weight stable & captured",
                        ok:
                          weightState === "stable" ||
                          weightState === "captured",
                      },
                      {
                        label: "Net weight calculated positive (11,350 KG)",
                        ok: netWeightKg > 0,
                      },
                      {
                        label: "Tare tolerance check (±500 KG limit)",
                        ok: weightState !== "tolerance-warning",
                      },
                      {
                        label: "WB-01 station online & operator verified",
                        ok: !isWbOffline,
                      },
                      {
                        label: "Before & after vehicle photos attached",
                        ok: !isCameraOffline,
                      },
                    ].map((chk) => (
                      <div
                ...
                >
                  <button
                    onClick={handleCompleteWeighment}
                    disabled={
                      weightState !== "captured" && weightState !== "stable"
                    }
                    style={{
                      width: "100%",
                      height: 56,
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Gross: <strong>24,850 KG</strong> | Tare:{" "}
                      <strong>13,500 KG</strong>
                    </div>
                    <div
                      style={{
                        fontSize: 32,
            ...
            {showCancelModal && (
              ...
              >
                ...
                >
                  ...
                  >
                    This weighment (TN22GH3456) will be cancelled before second
                    weighing completion.
                  </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="State reason for manual tare override..."
                        required
                        style={{
                          width: "100%",
                          height: 44,
