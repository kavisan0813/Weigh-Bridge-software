        ...
        {showDeactivateModal && (
          ...
          >
            ...
            >
              ...
              >
                Historical transactions will remain available and unchanged.
              </p>
              <div
        ...
        >
          ...
          >
            <div>
              ...
              >
                Complete driver information, license status and weighment
                activity.
              </p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              {role === "admin" && (
                <>
                  ...
                  <button
                    onClick={() => onNavigate("driver-edit")}
                    style={{
                      height: 42,
                      padding: "0 18px",
                      borderRadius: 8,
                  ...
                  >
                    ...
                    <div style={{ padding: "0 20px 4px" }}>
                      ...
                      <InfoRow
                        ...
                        value="Regional Transport Office"
                      />
                      <InfoRow
                        label="Verification"
                        value="Verified"
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        2 vehicles assigned to this driver.
                      </div>
                    </div>
                    {role === "admin" && (
                      <button
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11.5, color: mutedText, marginTop: 2 }}
                    >
                      License, identity, and compliance documents.
                    </div>
                  </div>
                  {role === "admin" && (
                    <button
                            ...
                            style={{
                              ...
                              color:
                                doc.status === "EXPIRING SOON"
                                  ...
                                  : primaryText,
                              fontWeight:
                                doc.status === "EXPIRING SOON" ? 700 : 400,
                            }}
                          >
                            {doc.expiry}
                          </td>
            ...
            >
              ...
              >
                {[
                  ...
                  ["VEHICLES", "2", primaryText],
                  ["COMPLETION", "96.8%", statusSuccess],
                ].map(([l, v, c]) => (
                  <div
                    key={l}
                    style={{
              ...
              {[
                ...
                ["License No.", "TN-XX-XXXXXXXX"],
                ["License Type", "Heavy Vehicle"],
                ["License Expiry", "15 Jan 2027"],
