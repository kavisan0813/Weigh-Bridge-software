...
export default function WeighbridgeDetailScreen({
  darkMode: dm,
  onToggleDark,
  onNavigate,
}: Props) {
  ...
  const hardwareList = [
    ...
    },
    {
      name: "Camera (ANPR)",
      status: "CONNECTED",
      detail: "Hikvision 4K • IP 192.168.1.104",
      signal: "Online",
      ok: true,
    },
    {
      name: "RFID Reader",
      status: "CONNECTED",
      detail: "Zebra FX9600 • Antenna 1 & 2",
      signal: "99% RSSI",
      ok: true,
    },
    {
      ...
      status: "CONNECTED",
      detail: "Epson TM-T88VI • Paper 85%",
      signal: "Ready",
      ok: true,
    },
    {
      ...
      status: "CONNECTED",
      detail: "MC92/2M • Gate Position DOWN",
      signal: "Normal",
      ok: true,
    },
    {
        ...
        <main style={{ flex: 1, overflowY: "auto", padding: "24px 28px 40px" }}>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Section 1 — Current Live Operation
                </h2>
                <div style={{ fontSize: 12, color: p.muted, marginTop: 2 }}>
                  Real-time scale data and vehicle positioned on WB-01
                </div>
              </div>
              <span
                style={{
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontWeight: 600, color: p.text, marginTop: 2 }}
                    >
                      10:50:32 AM
                    </div>
                  </div>
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{ marginBottom: 14 }}>
              ...
              >
                Section 2 — Hardware Connectivity & Devices
              </h2>
              <div style={{ fontSize: 12, color: p.muted, marginTop: 2 }}>
                Real-time status for all equipment connected to WB-01
              </div>
            </div>
          ...
          >
            ...
            >
              ...
              >
                Section 4 — Today's Hourly Throughput
              </h2>
              <div style={{ fontSize: 11.5, color: p.muted, marginBottom: 14 }}>
                Vehicles processed per hour on WB-01
              </div>
            ...
            >
              ...
              >
                <span style={{ fontSize: 14, fontWeight: 700, color: p.text }}>
                  Section 5 — WB-01 Recent Transactions
                </span>
                <button
                  ...
                  <tbody>
                    {recentTransactions.map((tx) => (
                      ...
                      >
                        ...
                        <td
                          style={{ padding: "12px 16px", color: p.secondary }}
                        >
                          {tx.material}
                        </td>
                        <td
            ...
            >
              ...
              >
                {[
                  ...
                  [
                    "10:48 AM",
                    "Vehicle positioned on scale",
                    "TN20AB1234",
                    "#8B5CF6",
                  ],
                  [
                    "10:47 AM",
                    "Vehicle detected by ANPR",
                    "TN20AB1234",
                    "#2563EB",
                  ],
          ...
          >
            ...
            >
              ...
              >
                Section 8 — Weighbridge Info
              </div>
              <div
                style={{ fontSize: 11.5, color: p.secondary, lineHeight: 1.6 }}
              >
                Capacity: <b>60,000 KG</b>
                <br />
                Platform: <b>18m × 3m</b>
                <br />
                Installed: <b>12 Jan 2025</b>
                <br />
              ...
              >
                {hardwareList.map((h) => (
                  ...
                  >
                    <div>
                      <div
                        style={{ fontSize: 13, fontWeight: 700, color: p.text }}
                      >
                        {h.name}
                      </div>
                      <div
