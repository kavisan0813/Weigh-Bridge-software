...
export default function VehicleManagementScreen({
  ...
  const [detailDrawerItem, setDetailDrawerItem] = useState<
    (typeof REGISTERED_VEHICLES)[0] | null
  >(null);
  ...
  const filtered = useMemo(() => {
    return REGISTERED_VEHICLES.filter((v) => {
      const matchQ = `${v.no} ${v.customer} ${v.driver}`
        .toLowerCase()
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <button
            onClick={() => onNavigate("vehicle-add")}
            style={{
              padding: "8px 16px",
              borderRadius: 8,
              border: 0,
        ...
        >
          <div style={{ flex: "1 1 240px" }}>
            <input
              ...
              placeholder="Search vehicle number, customer, driver..."
              style={{
                width: "100%",
                height: 42,
                borderRadius: 8,
                    ...
                    <td style={{ padding: "14px 16px" }}>
                      <span
                        style={{
                          ...
                          color: v.statusColor,
                          border: `1px solid ${v.statusColor}35`,
                        }}
                      >
                        ● {v.status}
                      </span>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <b>
                    {detailDrawerItem.make} {detailDrawerItem.model}
                  </b>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <b style={{ color: detailDrawerItem.docColor }}>
                    {detailDrawerItem.docStatus}
                  </b>
                </div>
              </div>
            </div>
      ...
      {importModalOpen && (
        ...
        >
          ...
          >
            ...
            >
              Upload a CSV or Excel spreadsheet containing vehicle registration
