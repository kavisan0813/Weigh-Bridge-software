...
const INITIAL_CUSTOMERS: CustomerItem[] = [
  { id: "CUS-00124", name: "Metro Builders Ltd", contactPerson: "Arun Kumar", phone: "+91 98400 12345", email: "info@metrobuilders.com", type: "Company", vehicles: 24, drivers: 18, status: "ACTIVE", lastWeighment: "19 Aug 2026", lastWeighmentTime: "11:14 AM", weighbridge: "WB-01", totalTransactions: 342 },
  { id: "CUS-00125", name: "Southern Rocks Co", contactPerson: "Ravi Kumar", phone: "+91 98761 12345", email: "contact@southernrocks.com", type: "Contractor", vehicles: 17, drivers: 13, status: "ACTIVE", lastWeighment: "19 Aug 2026", lastWeighmentTime: "10:45 AM", weighbridge: "WB-01", totalTransactions: 218 },
  { id: "CUS-00126", name: "Chennai Infrastructure Pvt Ltd", contactPerson: "Suresh Kumar", phone: "+91 98654 12345", email: "projects@chennaiinfra.com", type: "Company", vehicles: 8, drivers: 6, status: "ACTIVE", lastWeighment: "18 Aug 2026", lastWeighmentTime: "04:12 PM", weighbridge: "WB-02", totalTransactions: 145 },
  { id: "CUS-00127", name: "Green Valley Materials", contactPerson: "Priya Kumar", phone: "+91 99443 12098", email: "orders@greenvalley.com", type: "Supplier/Customer", vehicles: 4, drivers: 3, status: "INACTIVE", lastWeighment: "15 Aug 2026", lastWeighmentTime: "01:30 PM", weighbridge: "WB-03", totalTransactions: 89 },
  { id: "CUS-00128", name: "Apex Mining Corp", contactPerson: "Karthik P.", phone: "+91 97890 43211", email: "mining@apexcorp.com", type: "Company", vehicles: 31, drivers: 22, status: "ACTIVE", lastWeighment: "19 Aug 2026", lastWeighmentTime: "09:20 AM", weighbridge: "WB-01", totalTransactions: 512 },
  { id: "CUS-00129", name: "Delta Logistics", contactPerson: "Selvam T.", phone: "+91 98400 99887", email: "dispatch@deltalogistics.com", type: "Contractor", vehicles: 12, drivers: 9, status: "SUSPENDED", lastWeighment: "10 Aug 2026", lastWeighmentTime: "11:05 AM", weighbridge: "WB-04", totalTransactions: 67 },
  { id: "CUS-00130", name: "Kumar & Sons Enterprises", contactPerson: "Manoj Kumar", phone: "+91 97100 55443", email: "support@kumarent.com", type: "Individual", vehicles: 2, drivers: 2, status: "BLOCKED", lastWeighment: "02 Aug 2026", lastWeighmentTime: "02:15 PM", weighbridge: "WB-05", totalTransactions: 14 },
];

export default function CustomerManagementScreen({ darkMode, onToggleDark, onLogout, onNavigate }: Props) {
  const dm = darkMode;
  ...
  const hasActiveFilters = searchQuery !== "" || statusFilter !== "All" || typeFilter !== "All" || wbFilter !== "All";
          ...
          <header style={{ height: 68, padding: "0 32px", background: surface, borderBottom: `1px solid ${border}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
            <div>
              ...
              <p style={{ fontSize: 12, color: mutedText, margin: "2px 0 0 0" }}>
                Manage customers, company information, vehicles, drivers and weighment activity.
              </p>
            </div>
          ...
          <div style={{ flex: 1, padding: 32, display: "flex", flexDirection: "column", gap: 20, overflowY: "auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
              ...
              <div style={{ padding: 18, borderRadius: 12, background: elevated, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: mutedText, letterSpacing: "0.05em" }}>TOTAL CUSTOMERS</div>
                <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "monospace", color: primaryOrange, marginTop: 4 }}>84</div>
                <div style={{ fontSize: 11.5, color: secondaryText, marginTop: 2 }}>Registered customer accounts</div>
              </div>

              {/* Card 2 */}
              <div style={{ padding: 18, borderRadius: 12, background: elevated, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: mutedText, letterSpacing: "0.05em" }}>ACTIVE</div>
                <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "monospace", color: statusSuccess, marginTop: 4 }}>76</div>
                <div style={{ fontSize: 11.5, color: statusSuccess, fontWeight: 700, marginTop: 2 }}>● Currently active</div>
              </div>

              {/* Card 3 */}
              <div style={{ padding: 18, borderRadius: 12, background: elevated, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: mutedText, letterSpacing: "0.05em" }}>WITH WEIGHMENTS</div>
                <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "monospace", color: secondaryGold, marginTop: 4 }}>68</div>
                <div style={{ fontSize: 11.5, color: secondaryGold, fontWeight: 700, marginTop: 2 }}>Customers with transactions</div>
              </div>

              {/* Card 4 */}
              <div style={{ padding: 18, borderRadius: 12, background: elevated, border: `1px solid ${border}` }}>
                <div style={{ fontSize: 11, fontWeight: 700, color: mutedText, letterSpacing: "0.05em" }}>INACTIVE</div>
                <div style={{ fontSize: 32, fontWeight: 800, fontFamily: "monospace", color: mutedText, marginTop: 4 }}>8</div>
                <div style={{ fontSize: 11.5, color: mutedText, fontWeight: 600, marginTop: 2 }}>Requires attention</div>
              </div>
            </div>
            ...
            <div style={{ background: surface, borderRadius: 14, border: `1px solid ${border}`, overflow: "hidden" }}>
              ...
              {filteredList.length === 0 ? (
                <div style={{ padding: 48, textAlign: "center" }}>
                  ...
                  <h4 style={{ margin: 0, fontSize: 18, fontWeight: 800, color: primaryText }}>No Customers Found</h4>
                ...
                <div style={{ overflowX: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13, textAlign: "left" }}>
                    <thead>
                      <tr>
                        <th style={thStyle} onClick={() => handleSort("name")}>CUSTOMER {sortField === "name" && (sortOrder === "asc" ? "↑" : "↓")}</th>
                        <th style={thStyle} onClick={() => handleSort("id")}>CUSTOMER ID {sortField === "id" && (sortOrder === "asc" ? "↑" : "↓")}</th>
                        <th style={thStyle}>CONTACT</th>
                        <th style={thStyle}>PHONE</th>
                        <th style={thStyle} onClick={() => handleSort("vehicles")}>VEHICLES {sortField === "vehicles" && (sortOrder === "asc" ? "↑" : "↓")}</th>
                        <th style={thStyle} onClick={() => handleSort("drivers")}>DRIVERS {sortField === "drivers" && (sortOrder === "asc" ? "↑" : "↓")}</th>
                          ...
                          >
                            ...
                            <td style={tdStyle}>
                              <div>
                                ...
                                <div style={{ fontSize: 11, color: mutedText }}>{row.type} • {row.totalTransactions} transactions</div>
                              </div>
                            </td>
                            ...
                            {/* Contact Person */}
                            <td style={{ ...tdStyle, color: secondaryText }}>{row.contactPerson}</td>

                            {/* Phone */}
                            <td style={{ ...tdStyle, color: secondaryText }}>{row.phone}</td>

                            {/* Vehicles Count */}
                            <td style={{ ...tdStyle, fontWeight: 700, fontVariantNumeric: "tabular-nums" }}>{row.vehicles}</td>

                            {/* Drivers Count */}
                            <td style={{ ...tdStyle, fontWeight: 700, fontVariantNumeric: "tabular-nums" }}>{row.drivers}</td>
              ...
              {filteredList.length > 0 && (
                <div style={{ padding: "14px 20px", borderTop: `1px solid ${border}`, display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 12.5, color: mutedText }}>
                  <span>
                    Showing {Math.min((page - 1) * pageSize + 1, filteredList.length)}–{Math.min(page * pageSize, filteredList.length)} of {filteredList.length} customers
                  </span>
        ...
        <div style={{ display: "flex", justifyContent: "center", padding: "16px 0 40px" }}>
          ...
          >
            ...
            <div style={{ padding: "14px 18px", borderBottom: `1px solid ${border}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <div style={{ fontSize: 16, fontWeight: 800, color: primaryText }}>Customers</div>
                <div style={{ fontSize: 11, color: secondaryGold, fontWeight: 700 }}>84 Accounts</div>
              </div>
              {role === "admin" && (
                <button
            ...
            <div style={{ padding: "16px 16px 90px 16px", flex: 1, display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                <div style={{ padding: 10, borderRadius: 10, background: elevated, border: `1px solid ${border}` }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: mutedText }}>TOTAL CUSTOMERS</div>
                  <div style={{ fontSize: 20, fontWeight: 800, color: primaryOrange, marginTop: 2 }}>84</div>
                </div>
                <div style={{ padding: 10, borderRadius: 10, background: elevated, border: `1px solid ${border}` }}>
                  <div style={{ fontSize: 10, fontWeight: 700, color: statusSuccess }}>ACTIVE</div>
                  <div style={{ fontSize: 20, fontWeight: 800, color: statusSuccess, marginTop: 2 }}>76</div>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: primaryOrange, fontFamily: "monospace", fontWeight: 700, marginTop: 2 }}>{item.id}</div>
                      </div>
                    ...
                    <div style={{ fontSize: 12, color: secondaryText, display: "flex", flexDirection: "column", gap: 3 }}>
                      <div>Contact: <strong>{item.contactPerson}</strong></div>
                      <div>Phone: <strong>{item.phone}</strong></div>
                      <div>Vehicles: <strong>{item.vehicles}</strong> • Drivers: <strong>{item.drivers}</strong></div>
                    </div>
                    ...
                    <div style={{ paddingTop: 6, borderTop: `1px solid ${divider}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <button
                        onClick={(e) => { e.stopPropagation(); onNavigate("customer-detail"); }}
            ...
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 60, background: surface, borderTop: `1px solid ${border}`, display: "grid", gridTemplateColumns: "repeat(5, 1fr)", alignItems: "center", textTransform: "uppercase" }}>
              ...
              <button onClick={() => onNavigate("customers")} style={{ background: "none", border: "none", color: primaryOrange, fontSize: 10, fontWeight: 800, cursor: "pointer" }}>Customers</button>
