...
const INITIAL_DRIVERS: DriverItem[] = [
  ...
  },
  {
    ...
    license: "TN-XX-AAAAAAAA",
    licenseStatus: "EXPIRED",
    vehicle: "—",
    customer: "—",
    status: "BLOCKED",
    lastWeighment: "17 Aug 2026",
    lastWeighmentTime: "02:16 PM",
    weighbridge: "WB-03",
    totalWeighments: 42,
  },
  {
    ...
    license: "TN-XX-BBBBBBBB",
    licenseStatus: "VALID",
    vehicle: "TN11EF9021",
    customer: "Delta Mining Corp",
    status: "ACTIVE",
    lastWeighment: "16 Aug 2026",
    lastWeighmentTime: "09:30 AM",
    weighbridge: "WB-01",
    totalWeighments: 112,
  },
  {
    ...
    license: "TN-XX-CCCCCCCC",
    licenseStatus: "VALID",
    vehicle: "TN18CD4521",
    customer: "Apex Infrastructure",
    status: "INACTIVE",
    lastWeighment: "12 Aug 2026",
    lastWeighmentTime: "03:45 PM",
    weighbridge: "WB-02",
    totalWeighments: 78,
  },
  {
    ...
    license: "TN-XX-DDDDDDDD",
    licenseStatus: "NOT VERIFIED",
    vehicle: "TN05XY1122",
    customer: "Kumar Traders",
    status: "SUSPENDED",
    lastWeighment: "05 Aug 2026",
    lastWeighmentTime: "11:20 AM",
    weighbridge: "WB-04",
    totalWeighments: 15,
  },
];
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#F9FAFB" }}>
                DRIVER MANAGEMENT CONTROL CENTER
              </div>
              <div
                style={{
                  fontSize: 10.5,
              ...
              >
                SCREEN 31 — DRIVER LIST & DIRECTORY
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Manage drivers, licenses, vehicle assignments and driver
                activity.
              </p>
            </div>
                      ...
                      {paginatedList.map((row) => {
                        const licColor =
                          row.licenseStatus === "VALID"
                            ? statusSuccess
                            : row.licenseStatus === "EXPIRING SOON"
                              ? statusWarning
                            ...
                            <td style={tdStyle}>
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <div
                                    style={{ fontSize: 11, color: mutedText }}
                                  >
                                    {row.totalWeighments} weighments
                                  </div>
                                </div>
                              </div>
                            </td>
