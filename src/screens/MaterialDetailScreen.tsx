...
export default function MaterialDetailScreen({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "suppliers" | "weighbridges" | "transactions"
  >("overview");
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
              ...
              <div>
                ...
                >
                  ...
                  <span>
                    Category:{" "}
                    <strong style={{ color: primaryText }}>Aggregates</strong>
                  </span>
                  <span>
                    Measurement Unit:{" "}
                    <strong
                      style={{ color: secondaryGold, fontFamily: "monospace" }}
                    >
                      TON
                    </strong>
                  </span>
          ...
          {activeTab === "overview" && (
            ...
            >
              ...
              >
                ...
                >
                  Standard 20mm crushed granite blue metal aggregate used for
                  structural concrete mixes, road construction, and commercial
                  slab foundations. Supplied across all active weighbridges
                  (WB-01 to WB-05).
                </p>
              </div>
            </div>
          ...
          {activeTab === "suppliers" && (
            ...
            >
              ...
              >
                {[
                  "Southern Rocks Co",
                  "Chennai Aggregates Pvt Ltd",
                  "Deccan Quarry Works",
                  "Kaveri Mining Corp",
                  "Green Valley Materials",
                  "Metro Stone Suppliers",
                ].map((sup, i) => (
                  <div
                    key={i}
                    style={{
