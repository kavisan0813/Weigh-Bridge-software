...
export default function AppShell({
  ...
  const getBreadcrumbContext = () => {
    switch (activeView) {
      case "dashboard": case "operator-dashboard": return "Overview / Dashboard";
      case "monitoring": case "live-weighment": case "detail": return "Operations / Live Weighbridge";
      case "vehicle-entry": return "Operations / Vehicle Visits";
      case "transactions": case "transaction-detail": case "second-weighment": return "Operations / Weighments";
      case "pending": case "pending-weighments": return "Operations / Pending Weighments";
      case "tickets": case "ticket-detail": case "ticket-preview": return "Support / Tickets";
      ...
      case "weighbridges": return "Weighbridge / Weighbridges";
      case "device-monitoring": return "Weighbridge / Device Monitoring";
      case "indicators": return "Weighbridge / Weight Indicators";
      case "cameras": return "Weighbridge / Cameras";
      case "printers": return "Weighbridge / Printers";
      case "calibration": return "Weighbridge / Calibration";
      case "billing": return "Finance / Billing & Invoices";
      case "employees": return "Administration / Employees";
      case "reports": case "weighment-report": case "performance-report": case "customer-report": return "Reports / Report Center";
    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", background: bg, color: primaryText, fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{ marginLeft: sidebarWidth, display: "flex", flexDirection: "column", minHeight: "100vh", transition: "margin-left 0.2s ease" }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 13.5, fontWeight: 700, color: primaryText }}>
