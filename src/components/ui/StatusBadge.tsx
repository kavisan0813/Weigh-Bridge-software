...
export function StatusBadge({ status, darkMode = false, size = "md", className = "" }: StatusBadgeProps) {
  ...
  switch (normalizedStatus) {
    ...
    case "PROCESSING":
      ...
      icon = (
        <svg className="w-3 h-3 text-[#8B5CF6] animate-spin" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
