...
export default function Sidebar({
    ...
    const baseSections: NavSection[] = [
      {
        ...
        items: [
          {
            key: "monitoring",
            label: "Live Weighbridge",
            icon: (c) => <ScaleIcon color={c} />,
          },
          {
            key: "vehicle-entry",
            label: "Vehicle Visits",
            icon: (c) => <TruckIcon color={c} />,
          },
          {
            key: "transactions",
            label: "Weighments",
          ...
          {
            key: "tickets",
            label: "Weighment Tickets",
            icon: (c) => <TicketIcon color={c} />,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            key: "drivers",
            label: "Drivers",
            icon: (c) => <UserRoundIcon color={c} />,
          },
          {
            key: "customers",
            label: "Customers",
            icon: (c) => <BuildingIcon color={c} />,
          },
          ...(isAdmin
            ? [
              {
  ...
  const isItemActive = useCallback(
    (itemKey: string): boolean => {
      switch (itemKey) {
        case "dashboard":
          return (
            activeView === "dashboard" || activeView === "operator-dashboard"
          );
        case "monitoring":
          return (
            activeView === "monitoring" ||
            activeView === "live-weighment" ||
            activeView === "detail"
          );
        case "vehicle-entry":
        ...
        case "transactions":
          return (
            ...
            activeView === "transaction-detail" ||
            activeView === "second-weighment"
          );
        case "pending":
          return (
            activeView === "pending" || activeView === "pending-weighments"
          );
        case "tickets":
          return (
            activeView === "tickets" ||
            activeView === "ticket-detail" ||
            activeView === "ticket-preview"
          );
        case "vehicles":
          return (
            activeView === "vehicles" ||
            activeView === "vehicle-detail" ||
            activeView === "vehicle-add" ||
            activeView === "vehicle-edit"
          );
        case "drivers":
          return (
            activeView === "drivers" ||
            activeView === "driver-detail" ||
            activeView === "driver-add" ||
            activeView === "driver-edit"
          );
        case "customers":
          return (
            activeView === "customers" ||
            activeView === "customer-detail" ||
            activeView === "customer-add" ||
            activeView === "customer-edit"
          );
        case "suppliers":
          return (
            activeView === "suppliers" ||
            activeView === "supplier-detail" ||
            activeView === "supplier-add" ||
            activeView === "supplier-edit"
          );
        case "materials":
          return (
            activeView === "materials" ||
            activeView === "material-detail" ||
            activeView === "material-add" ||
            activeView === "material-edit"
          );
        case "weighbridges":
  ...
  const findActiveSectionTitle = useCallback((): string => {
    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={() =>
            onNavigate(
              userRole === "operator" ? "operator-dashboard" : "dashboard",
            )
          }
        ...
        >
          ...
          <span style={{ display: "flex", flexShrink: 0 }}>
            <DashboardIcon
              color={isDashboardActive ? primaryOrange : secondaryGold}
            />
          </span>
          {!collapsed && (
            <span
        ...
        {sections.map((section) => {
          const isOpen =
            ...
            section.title === findActiveSectionTitle();
      ...
      >
        ...
        >
          <span style={{ display: "flex", flexShrink: 0 }}>
            {collapsed ? (
              <PanelLeftIcon color={primaryOrange} />
            ) : (
              <PanelLeftCloseIcon color={primaryOrange} />
            )}
          </span>
          {!collapsed && (
            <span
